function [init_sig1,le_array,re_array,ild_array,itd_array,freq_array] = positionMode(x,y,x1,y1,x2,y2,num_so)
...
res = 0.09;              % Resolution of analysis
